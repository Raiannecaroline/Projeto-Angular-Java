...
public class ServicoController {
	...
	/**
	 * Mapeamento para mostrar todos os serviços
	 */
	@GetMapping("/servico")
	...
	public List<Servico> buscarServicoDoFuncionario(@PathVariable Integer idFuncionario){
		List<Servico> servicos = servicoService.buscarServicoDoFuncionario(idFuncionario);
		return servicos;
	}
	
	/*@GetMapping("/servicoData2/{dataEntrada}")
	public List<Servico> buscarServicoPelaData2(@PathVariable Date dataEntrada){
		List<Servico> servicos = servicoService.buscarServicoPelaData(dataEntrada);
		return servicos;
	}*/
	
	/**
	 * @Request permite que os dados da requisição venham peos parâmetros da requisição.
	 * @param dataEntrada
	 * @return
	 */
	...
	public List<Servico> buscarServicoPorIntervaloData(@RequestParam("data1") @DateTimeFormat(
			iso = DateTimeFormat.ISO.DATE) Date data1, @RequestParam("data2") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date data2){
